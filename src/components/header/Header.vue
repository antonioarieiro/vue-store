      ...
      <div class="flex flex-wrap items-center justify-between">
        <div class="flex w-0 flex-1 items-center">
          <span class="flex rounded-lg bg-indigo-800 p-2">
            <span
              class="material-icons text-white md-36 hover:cursor-pointer hover:text-yellow-300"
              >storefront</span
            >
          </span>
        ...
        <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
          ...
          >
            ...
            <span
              class="material-icons md-36 text-white hover:cursor-pointer hover:text-yellow-300"
              >shopping_cart</span
            >
          </button>
        </div>
